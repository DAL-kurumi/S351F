...
class OllamaChatbot:
    def __init__(self, base_url, model):
        ...
        self.system_prompt = "You will now play the role of a teacher's assistant. The user will ask you questions. Please answer them in the tone of a teacher's assistant and provide some teaching suggestions."
        # self.system_prompt = "You will now play the role of a teacher to conduct paper teaching. When students ask you questions, please do not give answers, but guide students to solve the problems step by step."
        self.keep_alive = "10m"
